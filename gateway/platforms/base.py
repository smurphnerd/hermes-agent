        ...
        try:
            ...
            if response:
                ...
                if text_content:
                    ...
                    # Check reply_to_mode config: "off" sends standalone messages
                    _reply_mode = getattr(self.config, 'reply_to_mode', 'first') or 'first'
                    _reply_ref = event.message_id if _reply_mode != 'off' else None
